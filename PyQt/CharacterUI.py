...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton.setGeometry(QtCore.QRect(240, 320, 111, 41))
        self.pushButton.setObjectName("pushButton")
        self.ORB = QtWidgets.QPushButton(Form)
        self.ORB.setGeometry(QtCore.QRect(370, 380, 111, 41))
        self.ORB.setObjectName("ORB")
        self.SURF = QtWidgets.QPushButton(Form)
        self.SURF.setGeometry(QtCore.QRect(370, 320, 111, 41))
        self.SURF.setObjectName("SURF")
        self.LDP = QtWidgets.QPushButton(Form)
        self.LDP.setGeometry(QtCore.QRect(240, 380, 111, 41))
    ...
    def retranslateUi(self, Form):
        ...
        self.savedb.setText(_translate("Form", "保存到图像库"))
